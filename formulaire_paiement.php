...
<tr>
<td>Mail de livraison</td>
<td><input type="email" name="mail_livraison" value=<?php echo $_SESSION['Mail'] ?> required></td>
</tr>
<tr>
<td>Adresse de livraison</td>
<td><input type="text" name="adresse_pour_livraison" value="<?php echo $_SESSION['adresse_livraison']; ?>" required></td>
</tr>
<tr>
...
<input type="hidden" name="montant_a_payer" value="<?php echo $total; ?>">
